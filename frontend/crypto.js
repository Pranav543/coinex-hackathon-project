...
var contractAbi = [
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_depositIdx", type: "uint256" },
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "_hashedPassword", type: "bytes32" },
      {
        internalType: "uint256",
        name: "_unlockDepositAmount",
        type: "uint256",
      },
    ],
    name: "depositEther",
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "bytes32", name: "hashedPassword", type: "bytes32" },
      { internalType: "uint256", name: "unlockDepositAmount", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [{ internalType: "uint256", name: "_depositIdx", type: "uint256" }],
    name: "getDeposit",
    outputs: [
...
if (idx && password && unlockDepositAmount && chain) {
  ...
  document.getElementById("fetchUnlockDepositAmount").value =
    unlockDepositAmount;
...
var blockExplorers = {
  coinex: "https://testnet.coinex.net/",
};
...
async function deposit() {
  ...
  var unlockDepositAmount = document.getElementById(
    "unlockDepositAmount"
  ).value;
  ...
  try {
    ...
    Alpine.store(
      "depositSuccessTxLink",
      blockExplorers[Alpine.store("gChain")] + "tx/" + receipt.transactionHash
    );
...
async function withdrawEtherPassword() {
  ...
  let unlockDepositAmount = document.getElementById(
    "fetchUnlockDepositAmount"
  ).value;
  console.log(
    "depositIdx: " + depositIdx,
    "depositPassword: " + depositPassword,
    "unlockDepositAmount: " + unlockDepositAmount
  );
  ...
  try {
    ...
    let blockUrl =
      blockExplorers[Alpine.store("gChain")] + "tx/" + receipt2.transactionHash;
